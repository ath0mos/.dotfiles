...

{
  ...
  nix.optimise.dates = [ "04:20" ]; # Optional; allows customizing optimisation schedule

  # AUDIO GROUP WAS ONLY TEST FOR PULSEAUDIO
   users.users.ath0mos_ = {
     isNormalUser = true;
     home = "/home/ath0mos_";
     extraGroups = [ "wheel" "networkmanager" "shared" "audio" ]; # Enable ‘sudo’ for the user.
     packages = with pkgs; [
       firefox
       tree
     ];
